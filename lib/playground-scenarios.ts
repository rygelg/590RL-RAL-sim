...
export const playgroundScenarios: PlaygroundScenario[] = [
  {
    ...
    descriptionShort:
      "AMIP targets the highest-leverage votes: 60 drops is enough to swap #1 and #2 on this 3,000-vote Arena slice.",
    description:
  ...
  },
  {
    ...
    descriptionShort:
      "Scale the same targeted drops to 10% and the instability spreads across the top of the board.",
    description:
  ...
  },
  {
    ...
    descriptionShort:
      "Drop the same 300 votes uniformly at random and the top rank usually holds.",
    description:
  ...
  },
  {
    ...
    descriptionShort:
      "Capping high-leverage votes raises α_flip, so the same 2% AMIP budget no longer flips #1.",
    description:
